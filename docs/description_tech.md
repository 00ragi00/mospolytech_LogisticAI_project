...
За 3 месяца разработки мы научились работать с более сложными ИИ-моделями и улучшать пользовательский интерфейс. На основе полученных знаний было решено модифицировать MathBot, добавив поддержку мультиязычности и улучшенный режим статистики.
